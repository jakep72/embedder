...
def get_app_layout():
    """Define app layout"""
    return html.Div([
        html.H1("CLIP Image Embeddings Visualizer", style={"textAlign": "center", "padding": "20px"}),
        ...
        html.Div(
            [
                ...
                ], style={"width": "15%", "display": "inline-block", "vertical-align": "top", "padding": "20px", "height": "92vh", "backgroundColor": "#f9f9f9", "borderRight": "1px solid #ddd"}),
                
                html.Div([
                    html.H2("Embeddings", style={"textAlign": "center"}),
                    dcc.Graph(id="embeddings-graph")
                ], style={"width": "60%", "display": "inline-block", "vertical-align": "top", "padding": "0px", "height": "92vh"}),
                
                html.Div([
                    html.H2("Selected Images", style={"textAlign": "center"}),
                    html.Div(id="thumbnails")
                ], style={"width": "25%", "display": "inline-block", "vertical-align": "top", "padding": "20px", "height": "92vh", "overflowY": "scroll", "backgroundColor": "#f9f9f9", "borderLeft": "1px solid #ddd"})
            ],
...
# Callbacks
def update_graph(uploaded_images, reduction_method):
